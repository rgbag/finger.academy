...
############################################################
my $specificThingyBasePath = $dir."/thingy-build-system/admin-pwa/specificThingyInfo.js";
...
my $sourceInfoLink = $dir."/thingy-build-system/admin-pwa/sourceInfo.js"; 
...
if($result == 0) {
    print "package.json for admin-pwa is ready to go :-)\n";
} else {
